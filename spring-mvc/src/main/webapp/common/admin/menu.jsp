...
<!-- Phần menu -->
    ...
    <div class="sidenav-header">
      ...
      <a class="navbar-brand m-0" href=" https://demos.creative-tim.com/material-dashboard/pages/dashboard "
        target="_blank">
        <!-- <img src="./assets/img/small-logos/bluewind-logo.webp" class="navbar-brand-img h-100" alt="main_logo"> -->
        <span class="ms-1 font-weight-bold text-white">BlueWind ADMIN</span>
      </a>
    </div>
      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link text-white " href="./billing.html">
            <span class="nav-link-text ms-1">Quản lý đơn</span>
          </a>
        </li>
        ...
        <li class="nav-item">
          <a class="nav-link text-white " href="./notifications.html">
            <span class="nav-link-text ms-1">Quản lý nhãn hiệu</span>
          </a>
        </li>
